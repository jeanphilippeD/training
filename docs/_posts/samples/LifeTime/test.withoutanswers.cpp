...
TEST_CASE_METHOD( Fixture, "LifeTime", "[test]" )
{
    ...
    CHECK( ref.Check() == Valid{} );
    CHECK( s_live.size() == Unkown );
}
...
TEST_CASE_METHOD(
    ...
    "[test]" )
{
    Check( GetLifeTime().Check(), Valid{}, Unkown );
}
...
TEST_CASE_METHOD(
    ...
    "[test]" )
{
    Check( GetStructTest1().GetCRef().Check(), Valid{}, Unkown );
}
...
TEST_CASE_METHOD(
    ...
    "[test]" )
{
    Check( GetStructTest1().Get().Check(), Valid{}, Unkown );
}
